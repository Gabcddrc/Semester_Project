...
def scoring(prediction, true):
	...
	df.to_csv('/itet-stor/zhejiang/net_scratch/datasetv2/mistakes/seq2words_512_mistakes')
	return correct/n
...
model.load_state_dict(torch.load("/itet-stor/zhejiang/net_scratch/models/seq2words_512_500k.model"))


test_data = pd.read_csv(
	"/itet-stor/zhejiang/net_scratch/datasetv3/test.csv", index_col='Id')
